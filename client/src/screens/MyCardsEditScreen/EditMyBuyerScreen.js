import {View, Text, Image, StyleSheet, ImageBackground, Pressable, ScrollView, TextInput} from 'react-native'
  ...
  return (
    <View style = {{
      ...
      <View style = {{
        ...
        <Pressable onPress={() => navigation.navigate('Edit Buyer Details')}
          style = {styles.pressable}>
              <View>
                <Text style = {{
                fontSize: 16,
