  ...
  return (
    <NavigationContainer>
      {user !== null || user != undefined ? (
        ...
        <Stack.Navigator>
          ...
          {user?.isFirstTime && (
            <Stack.Screen
              name="Welcome"
              component={WelcomeProPic}
              options={{ headerShown: false, headerTintColor: "#593196" }}
            />
          )}
          <Stack.Screen
            name="Main"
          ...
          <Stack.Screen
            ...
            component={WelcomeImperial}
            options={{ headerShown: false }}
          />
          {/* {!isWelcomeFirst ? ( */}
          <Stack.Screen
            name="WelcomePost"
            component={WelcomeAddPost}
            options={{ headerShown: false }}
          />
          {/* ) : null} */}
          <Stack.Screen
      ...
      <Stack.Screen name="OnBoarding" component={OnBoarding} options={{headerShown: false}}/> */}
        ...
        <Stack.Navigator
          screenOptions={{ headerStyle: { backgroundColor: "#f9f8fc" } }}
        >
          {showOnBoarding ? (
            <Stack.Screen
              name="OnBoarding"
