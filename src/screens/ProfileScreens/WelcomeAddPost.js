...
const WelcomeAddPost = () => {
  ...
  const updateStatusandAddPost = async () => {
    ...
    await axios
      .put(`${API_BASE_URL}users/profile/?id=${user._id}`, userData, {
        headers: {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Unlock Seamless Logistics using Borsa, where Adventurous Travelers and
          Shippers Find Their Perfect Match!
        </Text>
      </View>
