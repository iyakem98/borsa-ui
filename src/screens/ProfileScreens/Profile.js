...
const ProfileScreen = ({ navigation }) => {
  ...
  const getCards = async (i) => {
    ...
    await axios
      .get(`http://143.198.168.244/api/travels/${i}`, config)
      .then((data) => {
    ...
    await axios
      .get(`http://143.198.168.244/api/buyers/${i}`, config)
      .then((data) => {
        setB(data.data.data);
                ...
                <View style={styles.myRow}>
                  <View style={styles.press}>
                    <View style={styles.pressView1}>
                      ...
                      >
                        {"Borsa user since " +
                          moment(route.params.theUser.createdAt).format(
                            "MMM YYYY"
                          )}
                      </Text>
                    </View>
