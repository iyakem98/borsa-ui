...
const FromTo = ({ navigation }) => {
  ...
  const [showDatePickerTravelerFrom, setShowTravelerDatePickerFrom] =
    useState(false);

  const [showDatePickerTravelerReturn, setShowTravelerDatePickerReturn] =
    useState(false);
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Header
        title={route.params?.cardType == 2 ? "Shipping" : "Traveling"}
        backBtn
      />
          ...
          >
            ...
            {showExpiryDate ? (
              ...
              <View>
                ...
                >
                  Shipping cards typically expire in 90 days. Would you like to
          ...
          >
            ...
            >
              <Pressable
                ...
                style={{
                  backgroundColor: `${roundTrip ? "#fff" : "#593196"}`,
                  borderRadius: 5,
                  width: "49%",
                  paddingVertical: 7,
                  alignItems: "center",
            ...
            {roundTrip && (
              <>
                ...
                <Pressable
                  ...
                  onPress={() => {
                    setShowTravelerDatePickerReturn(
                      !showDatePickerTravelerReturn
                    );
                  }}
                >
                  <Text
